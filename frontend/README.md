...
* An **api server** (in the folder `api-server`)
* A **frontend website** (in the folder `frontend`)

If you just downloaded the code you should install the packages first by
running:
...
After that, start the api-server and then the frontend website. Again, enter
both folders and run the following command:
